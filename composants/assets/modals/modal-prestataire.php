    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
           <div class="modal-header">
            ...
            <h4 class="modal-title">Formulaire des prestataires & concessionnaires</h4>
        ...
        <form method="POST" class="formShamman" classname="prestataire">
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <label>Registre de commerce <span1>*</span1></label>
                        <div class="form-group">
                            <input type="text" class="form-control" name="registre" required>
                        </div>
                    </div>
                </div>
