...
function isJourFerie($date)
{
	...
	// dates fériées fixes
	$tab[] = $annee."-01-01"; // 1er janvier Nouvel An 
	$tab[] = $annee."-05-01"; // fete du travail
	$tab[] = $annee."-08-07"; // Independante Nationnale CI
	$tab[] = $annee."-08-15"; // Assomption
	$tab[] = $annee."-11-01"; // Fete de Toussaint
	$tab[] = $annee."-12-25"; // Fete de Noel
	$tab[] = $annee."-12-31"; // Fete de la St Silvestre

	//Fetes religieuses
	$paques = date("Y-m-d", easter_date($annee)); // Fete de paques
	$tab[] = $paques;
	...
	return (in_array(dateAjoute(), $tab));
}
