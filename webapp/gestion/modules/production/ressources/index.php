            ...
            <div class="ibox-content">
                <div class="row text-center">
                    <?php $total = 0; foreach ($ressources as $key => $ressource) {
                        $stock = $ressource->stock(Home\PARAMS::DATE_DEFAULT, dateAjoute(1));
                        ...
                        <tbody>
                            ...
                            while ($index <= $date2) { ?>
                                <tr>
                                    ...
                                    <?php foreach ($ressources as $key => $ressource) {
                                        $stock = $ressource->stock($index, $index);
                                        $appro = $ressource->achat($index, $index);
                                        $conso = $ressource->consommee($index, $index);
                                        $perte = $ressource->perte($index, $index);
                                        ?>
