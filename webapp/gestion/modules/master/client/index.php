                        ...
                        <div class="ibox-content">
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <button type="button" <?= (count($client->groupecommandes) > 0)?" onclick='newcommande()' ": "data-toggle=modal data-target='#modal-newcommande.php'" ?>  class="btn btn-primary btn-sm dim pull-right"><i class="fa fa-plus"></i> Nouvelle commande </button>
                                    <div class="">
                                                ...
                                                <tbody>
                                                    <?php foreach ($client->groupecommandes as $key => $commande) {
                                                        ...
                                                        <tr class=" border-bottom">                                
                                                           ...
                                                           <td>
                                                            <button onclick="fichecommande(<?= $commande->getId()  ?>)" class="btn btn-white btn-sm"><i class="fa fa-plus text-green"></i> de détails </button>
                                                        </td>
                                                    </tr>
                                                <?php  } ?>
                                            </tbody>
                        ...
                        <div class="tab-content">
                            <div id="contact-1" class="tab-pane active">
                                ...
                                <div class="m-b-lg">
                                    ...
                                    <h2 class="font-bold"><?= money($client->acompte) ?> <?= $params->devise  ?></h2>
