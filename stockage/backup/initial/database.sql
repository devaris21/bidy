...
--
-- Structure de la table `ligneautrepertejour`
--
...
--
-- Structure de la table `lignechangement`
--
...
CREATE TABLE `produit` (
  ...
  `stock` text COLLATE utf8_bin NOT NULL COMMENT 'le stock initial',
  `image` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `protected` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `ressource` (
  ...
  `stock` int(11) NOT NULL DEFAULT '0' COMMENT 'stock initial',
  `image` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `protected` int(11) NOT NULL DEFAULT '0',
...
--
-- Index pour la table `ligneautrepertejour`
--
ALTER TABLE `ligneautrepertejour`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `lignechangement`
--
ALTER TABLE `lignechangement`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `ligneautrepertejour`
--
ALTER TABLE `ligneautrepertejour`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `lignechangement`
--
ALTER TABLE `lignechangement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
